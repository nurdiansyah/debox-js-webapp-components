...
export const NavbarBrand: React$ComponentType<NavbarBrandProps & StylesProps> = injectClassNames('navbar', {keepStyles: true})(_NavbarBrand)
export const NavbarDropdown: React$ComponentType<NavbarDropdownProps & StylesProps> = injectClassNames('navbar')(_NavbarDropdown)
export const NavbarItem: React$ComponentType<NavbarItemProps & StylesProps> = injectClassNames('navbar', {keepStyles: true})(_NavbarItem)
export const NavbarToggler: React$ComponentType<NavbarTogglerProps & StylesProps> = injectClassNames('navbar')(_NavbarToggler)
