...
export const PaginationItem: React$ComponentType<PaginationItemProps & StylesProps> = injectClassNames('pagination')(_PaginationItem)
export const PaginationLink: React$ComponentType<PaginationLinkProps & StylesProps> = injectClassNames('pagination')(_PaginationLink)
